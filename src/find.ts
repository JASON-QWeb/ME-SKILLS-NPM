...
${DIM}  1) npx skillsandruless find [query]${RESET}
${DIM}  2) npx skillsandruless add <owner/repo@skill>${RESET}`;
  ...
  if (query) {
    ...
    console.log(`${DIM}Install with${RESET} npx skillsandruless add <owner/repo@skill>`);
    console.log();
