...
${DIM}  1) npx skillshub find [query]${RESET}
${DIM}  2) npx skillshub add <owner/repo@skill>${RESET}`;
  ...
  if (query) {
    ...
    console.log(`${DIM}Install with${RESET} npx skillshub add <owner/repo@skill>`);
    console.log();
